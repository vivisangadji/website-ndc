...
<!-- Jika pendaftaran sudah tutup -->
<?php else : ?>
<div class="content container my-5 bg-light">
	<div class="row pb-3">
		<div class="col-sm-12 my-3 d-flex justify-content-center">
			<div class="right_col p-5" role="main">
				<img class="mx-auto d-block" src= "<?= base_url('public/img/') ?>LOGO-NDC-UNDIPA.png" width="200px" height="200px" /> <br>
				<h5 class="text-secondary text-center">PENDAFTARAN CALON ANGGOTA</h5>
				<h5 class="text-secondary text-center">NIPHAZ DIPLOMA CLUB (NDC)</h5>
				<hr>
				<h4 size="5">Mohon Maaf Pendaftaran Telah Tertutup!</h4>
			</div>
		</div>
		</div>
	</div>
